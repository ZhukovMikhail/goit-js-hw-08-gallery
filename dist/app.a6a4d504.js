...
var listEl = galleryItems.map(function (_ref) {
  var preview = _ref.preview,
      original = _ref.original,
      description = _ref.description;
  return "<li class=\"gallery__item\"><a class=\"gallery__link\" href = \"".concat(original, "\"><img class=\"gallery__image\" src=\"").concat(preview, "\" alt=\"").concat(description, "\"></li></a>");
}).join(''); // console.log(listEl);
...
var modalClose = document.querySelector('[data-action="close-lightbox"]');
var modalImage = document.querySelector('.lightbox__image');
var originalSrcArray = galleryItems.map(function (_ref2) {
...
function leftKeyHandler(evt) {
  var currentImageIndex = originalSrcArray.indexOf(modalImage.src);
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "1434" + '/');
